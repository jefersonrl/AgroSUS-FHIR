# Exemplo de Solicitação de Colinesterase — Rotina Semestral (2027-07) - Projeto mareIA: módulo AgroSUS para telemonitoramento e apoio à identificação precoce de intoxicações por uso de defensivos agrícolas v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Exemplo de Solicitação de Colinesterase — Rotina Semestral (2027-07)**

## Example ServiceRequest: Exemplo de Solicitação de Colinesterase — Rotina Semestral (2027-07)

Língua: pt-BR

Perfil: [Solicitação de Exame AgroSUS](StructureDefinition-agrosus-solicitacao-exame.md)

**identifier**: `https://jefersonrl.github.io/AgroSUS-FHIR/sid/solicitacao-exame`/SOL-EXAME-2027-000003

**requisition**: `https://jefersonrl.github.io/AgroSUS-FHIR/sid/requisicao-laboratorial`/REQ-LAB-2027-000003
...
**occurrence**: 2027-07-22 08:10:00-0300

**authoredOn**: 2027-07-18 09:00:00-0300
...
```json
{
  ...
  "id" : "agrosus-solicitacao-colinesterase-semestral-2027-07-exemplo",
  "meta" : {
