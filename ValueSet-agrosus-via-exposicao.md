# Vias de exposição - Projeto mareIA: módulo AgroSUS para telemonitoramento e apoio à identificação precoce de intoxicações por uso de defensivos agrícolas v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vias de exposição**

## ValueSet: Vias de exposição 

| | |
| :--- | :--- |
| *Official URL*:https://jefersonrl.github.io/AgroSUS-FHIR/ValueSet/agrosus-via-exposicao | *Version*:0.1.0 |
| Active as of 2026-07-21 | *Computable Name*:AgroSUSViaExposicaoVS |

 
Vias mais comuns de exposição aos defensivos agrícolas. 
