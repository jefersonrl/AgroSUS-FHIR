...
8) REGISTRO: eventos de exame, afastamento e conduta devem ser mantidos no prontuário/registro individual por, no mínimo, 20 anos após o desligamento do trabalhador. Fonte: NR-7 item 7.4.5.1.ITEM EM ABERTO: não existe, nas fontes L1 adotadas, uma fórmula de escore composto de risco ocupacional. Ver ADR-0002 — não inferir pesos ou combinação entre os gatilhos acima sem validação clínica. |
...
| [Exemplo de Resultado de Colinesterase — Alterado](Observation-agrosus-resultado-colinesterase-alterada-exemplo.md) | Resultado fictício de colinesterase plasmática acima do Índice Biológico Máximo Permitido (inibição de 58,54%), exigindo afastamento do contato com o defensivo por 30 dias (DT-5). |
| [Exemplo de Resultado de Colinesterase — Normal](Observation-agrosus-resultado-colinesterase-normal-exemplo.md) | Resultado fictício de colinesterase plasmática dentro do limite aceitável (inibição de 14,63% em relação ao valor basal), na periodicidade semestral de rotina (NR-7 item 7.4.2.1). |
| [Exemplo de Resultado de Colinesterase — Precaução](Observation-agrosus-resultado-colinesterase-precaucao-exemplo.md) | Resultado fictício de colinesterase plasmática dentro do limite aceitável, mas na faixa de precaução (inibição de 39,02%), sem exceder o Índice Biológico Máximo Permitido (IBMP). |
| [Exemplo de Resultado de Colinesterase — Valor Basal](Observation-agrosus-resultado-colinesterase-basal-exemplo.md) | Valor basal fictício de colinesterase plasmática, obtido na admissão, antes do início do manuseio de organofosforados/carbamatos (NR-7 item 7.4.1; Nota Informativa 16/2019, Anexo I itens 1 e 3). |
...
| [Exemplo de Solicitação de Colinesterase — Rotina Semestral (2026-07)](ServiceRequest-agrosus-solicitacao-colinesterase-semestral-2026-exemplo.md) | Solicitação fictícia do exame de colinesterase na periodicidade semestral mínima de rotina (NR-7 item 7.4.2.1). |
| [Exemplo de Solicitação de Colinesterase — Rotina Semestral (2027-01)](ServiceRequest-agrosus-solicitacao-colinesterase-semestral-2027-01-exemplo.md) | Solicitação fictícia do exame de colinesterase na periodicidade semestral mínima de rotina (NR-7 item 7.4.2.1). |
| [Exemplo de Solicitação de Colinesterase — Rotina Semestral (2027-07)](ServiceRequest-agrosus-solicitacao-colinesterase-semestral-2027-07-exemplo.md) | Solicitação fictícia do exame de colinesterase na periodicidade semestral mínima de rotina (NR-7 item 7.4.2.1); resultado veio alterado (ver DT-5). |
| [Exemplo de Solicitação de Colinesterase — Valor Basal Admissional](ServiceRequest-agrosus-solicitacao-colinesterase-basal-exemplo.md) | Solicitação fictícia do exame de colinesterase realizada na admissão do trabalhador, antes do início do manuseio de organofosforados/carbamatos (NR-7 item 7.4.1). |
...
| [Exemplo de Solicitação de Retestagem de Colinesterase Pós-Resultado Alterado](ServiceRequest-agrosus-solicitacao-colinesterase-retestagem-exemplo.md) | Solicitação fictícia de retestagem da colinesterase 30 dias após o resultado alterado, conforme a conduta descrita em DT-5. |
