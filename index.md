...
| Draft as of 2026-07-20 | *Computable Name*:AgroSUSFHIR |
...
* [ISO 3166-1 Codes for the representation of names of countries and their subdivisions — Part 1: Country code](http://terminology.hl7.org/6.1.0/CodeSystem-ISO3166Part1.html): [AgroSUSFHIR](index.md)
...
```json
{
  ...
  "status" : "draft",
  "experimental" : true,
  "date" : "2026-07-20T19:33:39+00:00",
